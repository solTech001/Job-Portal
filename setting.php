...
<body class = " posistion-relative">
    ...
    <section>
        <div class="container register my-5">
            <form action="asset\Config\setting.php" method="post" class="card p-3 mx-auto shadow" style="max-width: 600px;">
                <?php echo ErrorMsg(); echo SuccessMsg();?>
                <h4 class="card-title text-center">Reset Password</h4>
                <h6 class = "text-center">Enter the email you register with!</h6>
                <input type="email" class="form-control mb-3" name="email" placeholder="Email" required>
                <!-- <input type="password" class="form-control mb-3" name="pass" placeholder="Password" autocomplete="off" required> -->
                
                <input type="submit" name="Reset" value="Reset" class="btn btn-dark mb-3">
            </form>
        </div>
    </section>
